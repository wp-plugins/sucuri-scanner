<tr>
    ...
    <td class="monospace">%%SUCURI.LoggedInUsers.LastActivity%%</td>
    <td class="monospace">%%SUCURI.LoggedInUsers.Registered%%</td>
    <td class="monospace">%%SUCURI.LoggedInUsers.RemoveAddr%%</td>
    <td>
